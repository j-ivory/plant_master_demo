...
class QuizBrain {
  ...
  String getQuestionName() {
    return questionBank[_questionNumber].name;
  }
  String getPicture() {
    return questionBank[_questionNumber].picURL;
  }
  String getSubject() {
    return questionBank[_questionNumber].subject;
  }
  ...
  String getReviewQuestionName() {

    return reviewBank[_reviewNumber].name;
  }

  String? getReviewQuestionPicture() {
    return reviewBank[_reviewNumber].picURL;
  }
  ...
  Future<List<Question>> getQuestions(String file) async {
     ...
     return Question.questionsFromSnapshotSimple(_questionList);
  }
